...
<xsl:template match="/atom:feed">
	...
	<link rel="canonical" href="http://malware2.dontneedcoffee.com/assets/xslt/atom.xslt">


	<!-- Facebook Open Graph -->
	<meta property="og:title" content="Atom Feed (Styled)">
	<meta property="og:description" content="Sleep is a symptom of  »caffeine« deprivation!">
	<meta property="og:url" content="http://malware2.dontneedcoffee.com/assets/xslt/atom.xslt">
  ...
  <nav class="top-bar" role="navigation" data-topbar>
    <ul class="title-area">
      <li class="name">
      <h1 class="show-for-small-only"><a href="http://malware2.dontneedcoffee.com" class="icon-tree"> MDNC | Malware don't need Coffee</a></h1>
    </li>
    ...
    <section class="top-bar-section">
      ...
      <ul class="left">
              ...
              <li><a href="http://malware2.dontneedcoffee.com/">Start</a></li>
              <li class="divider"></li>
              ...
              <li><a href="http://malware2.dontneedcoffee.com/getting-started/">Getting Started</a></li>
              <li class="divider"></li>
              ...
              <li class="has-dropdown">
                <a href="http://malware2.dontneedcoffee.com/design/">Templates</a>
                  ...
                  <ul class="dropdown">
                      ...
                      <li><a href="http://malware2.dontneedcoffee.com/design/grid/">Grid &amp; Colors</a></li>
                    

                      

                      <li><a href="http://malware2.dontneedcoffee.com/design/typography/typography/">Typography</a></li>
                    

                      

                      <li><a href="http://malware2.dontneedcoffee.com/design/page/">Page/Post</a></li>
                    

                      

                      <li><a href="http://malware2.dontneedcoffee.com/design/post-left-sidebar/">Post-Left-Sidebar</a></li>
                    

                      

                      <li><a href="http://malware2.dontneedcoffee.com/design/post-right-sidebar/">Post-Right-Sidebar</a></li>
                    

                      

                      <li><a href="http://malware2.dontneedcoffee.com/design/page-fullwidth/">Page Full-Width</a></li>
                    

                      

                      <li><a href="http://malware2.dontneedcoffee.com/blog/">Blog-Page</a></li>
                    

                      

                      <li><a href="http://malware2.dontneedcoffee.com/design/video/">Video</a></li>
                    

                      

                      <li><a href="http://malware2.dontneedcoffee.com/design/gallery/">Gallery</a></li>
                    

                      

                      <li><a href="http://malware2.dontneedcoffee.com/design/portfolio/">Portfolio</a></li>
              ...
              <li class="has-dropdown">
                <a href="http://malware2.dontneedcoffee.com/headers/">Header Styles</a>
                  ...
                  <ul class="dropdown">
                      ...
                      <li><a href="http://malware2.dontneedcoffee.com/design/header-full-width-image/">Header with Full-Width-Image</a></li>
                    

                      

                      <li><a href="http://malware2.dontneedcoffee.com/design/header-image-pattern/">Header with Image and Pattern</a></li>
                    

                      

                      <li><a href="http://malware2.dontneedcoffee.com/design/header-image-color/">Header with image and color</a></li>
                    

                      

                      <li><a href="http://malware2.dontneedcoffee.com/design/header-logo-only/">Header Only With Logo</a></li>
                    

                      

                      <li><a href="http://malware2.dontneedcoffee.com/design/header-with-text/">Header With Text</a></li>
                    

                      

                      <li><a href="http://malware2.dontneedcoffee.com/design/no-header/">No Header</a></li>
                    

                      

                      <li><a href="http://malware2.dontneedcoffee.com/design/no-header-but-image/">No Header but Image</a></li>
              ...
              <li class="has-dropdown">
                <a href="http://malware2.dontneedcoffee.com/documentation/">Documentation</a>
                  ...
                  <ul class="dropdown">
                      ...
                      <li><a href="http://malware2.dontneedcoffee.com/changelog/">Changelog</a></li>
                    

                      

                      <li><a href="http://malware2.dontneedcoffee.com/roadmap/">Roadmap</a></li>
              ...
              <li class="has-dropdown">
                <a href="http://malware2.dontneedcoffee.com/blog/">Blog</a>
